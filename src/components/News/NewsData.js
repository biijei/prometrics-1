...
export const newsData = [
  ...
  {
    // Template for content formatting demonstration | url- https://www.prometricspro.com/news/complete-content-formatting-guide:-all-available-styles?id=123
    id: '123', // Template ID - won't show in listings
    title: 'Complete Content Formatting Guide: All Available Styles',
    excerpt: 'This is a comprehensive template showing all available content formatting options including headings, paragraphs, mixed text, lists, quotes, and more.',
    coverImage: 'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=600&h=400&fit=crop',
    ...
    content: [
      // HEADING
      { type: 'heading', content: 'Main Heading Example' },
      
      // PARAGRAPH
      { type: 'paragraph', content: 'This is a regular paragraph with normal text formatting. It demonstrates how standard content appears in your articles with proper line spacing and readability.' },
      
      // BOLD TEXT
      { type: 'bold', content: 'This is bold text - perfect for emphasizing important points or subheadings' },
      
      // UNDERLINED TEXT
      { type: 'underline', content: 'This is underlined text - great for highlighting key information' },
      
      // ITALIC TEXT
      { type: 'italic', content: 'This is italic text - ideal for quotes, emphasis, or stylistic variation' },
      
      // MIXED TEXT (combination of formats in one paragraph)
      { type: 'mixedText', content: [
        { type: 'text', content: 'This paragraph demonstrates ' },
        { type: 'bold', content: 'mixed text formatting' },
        { type: 'text', content: ' where you can combine ' },
        { type: 'underline', content: 'underlined text' },
        { type: 'text', content: ', ' },
        { type: 'italic', content: 'italic text' },
        { type: 'text', content: ', and ' },
        { type: 'bold', content: 'bold text' },
        { type: 'text', content: ' all within a single paragraph for ' },
        { type: 'underline', content: 'maximum flexibility' },
        { type: 'text', content: '.' }
      ]},
      ...
      { type: 'bulletPoints', content: [
        ...
        'Third bullet point demonstrating list formatting',
        'Fourth point showing how lists can contain multiple items',
        'Final bullet point to complete the example'
      ]},
      
      // NUMBERED LIST
      { type: 'numberedList', content: [
        'First numbered item in sequential order',
        'Second numbered item continuing the sequence',
        'Third numbered item for step-by-step instructions',
        'Fourth numbered item showing progression',
        'Fifth and final numbered item'
      ]},
      
      // QUOTE
      { type: 'quote', content: 'This is a blockquote example. It\'s perfect for highlighting important statements, testimonials, or memorable quotes from interviews and research.' },
      
      // IMAGE
      { type: 'image', content: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=600&h=300&fit=crop', alt: 'Example article image', caption: 'Optional image caption explaining the visual content' },
      
      // HIGHLIGHT BOX
      { type: 'highlight', content: 'This is a highlighted text box that draws attention to important information, key takeaways, or special announcements that you want readers to notice.' },
      
      // DIVIDER
      { type: 'divider' },
      
      // ANOTHER HEADING
      { type: 'heading', content: 'Secondary Heading for New Section' },
      
      // MORE MIXED CONTENT
      { type: 'mixedText', content: [
        { type: 'text', content: 'You can create ' },
        { type: 'bold', content: 'complex combinations' },
        { type: 'text', content: ' of formatting. For example, this sentence has ' },
        { type: 'italic', content: 'italic emphasis' },
        { type: 'text', content: ' followed by ' },
        { type: 'underline', content: 'underlined importance' },
        { type: 'text', content: ' and then back to ' },
        { type: 'bold', content: 'bold statements' },
        { type: 'text', content: '.' }
      ]},
      
      // FINAL PARAGRAPH
      { type: 'paragraph', content: 'This template demonstrates all available formatting options. You can mix and match these content types to create rich, engaging articles that are both visually appealing and highly readable.' },
      
      // FINAL QUOTE
      { type: 'quote', content: 'Remember: Good content formatting enhances readability and keeps your audience engaged throughout the entire article.' }
    ]
  }
];