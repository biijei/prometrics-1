        ...
        <div className='px-[5%] py-[50px] sm:py-[100px] '>
          ...
          <div className='lg:grid grid-cols-[345px_auto] gap-x-16'>
            ...
            <div>
              ...
              <h3 className='text-[23px] font-semibold leading-tight mb-6'>Employment Consult</h3>
              ...
              <p className='text-justify mb-6'>At Prometrics Law Consulting, we recognize the unique challenges and aspirations of talented professionals like you. That&apos;s why we go above and beyond to ensure a smooth and seamless transition into the U.S. workforce. Whether you&apos;re a highly skilled researcher, academic, entrepreneur, or professional in any field, our comprehensive services are tailored to meet your specific needs and objectives. From initial consultation to visa application preparation and beyond, we&apos;re here to empower you to achieve your career goals with confidence and peace of mind.</p>
              <p className='text-justify mb-10'>With our proven track record of success and unwavering dedication to client satisfaction, Prometrics Law Consulting is your trusted partner in navigating the complex landscape of employment-based immigration. Let us help you unlock new opportunities and embark on an exciting journey toward professional growth and fulfillment in the United States. Contact us today to learn more about how we can assist you in securing your EB2-NIW or EB-1A visa and kickstart your career in the land of opportunity.</p>
              <div className='text-justify flex flex-col sm:flex-row items-center gap-x-6 gap-y-4 mt-4'>
...
export default PaEmploymentConsult