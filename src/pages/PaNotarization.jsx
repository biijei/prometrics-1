  ...
  return (
    <div>
      ...
      <div className='bg-tertiary mt-[90px] pb-[50px]'>
        <HeroSection subtitile='Practice Areas' titile='Notarization' 
          menu='Practice Areas' menudetails = '/ Notarization' bgimage='aboutbg'
        />
        <div className='px-[5%] py-[50px] sm:py-[100px] '>
          ...
          <div className='lg:grid grid-cols-[345px_auto] gap-x-16'>
            ...
            <div>
              ...
              <h3 className='text-[23px] font-semibold leading-tight mb-6'>Notarization</h3>
