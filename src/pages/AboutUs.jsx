    ...
    <div>
      ...
      <div className='bg-tertiary mt-[110px] by-[50px]'>
        ...
        <div className='flex flex-col items-center py-[50px] '>
          ...
          <div className='flex flex-col-reverse md:flex-row '>
            <div className='max-w-[600px] md:w-[400px] lg:w-[600px] h-[250px] md:h-[300px] bg-[#31281E] rounded-b-[20px] md:rounded-br-none md:rounded-l-[20px] flex flex-col justify-center items-center '>
              <p className='text-[#F2F8FC] max-w-[444px] px-8'>At Prometrics Legal Hub, we pride ourselves on our commitment to excellence and our unwavering dedication to client satisfaction. We are aware that a satisfied client is a business’ best marketing tool.</p>
            </div>
        ...
        <div className='px-[5%] py-[50px]'>
          ...
          <p className='mb-4 leading-loose'>Dr. (Mrs.) Fola Odion, JD, MBA moved to the USA on an F1 non-immigrant visa to tick one of her career goals off her box – getting an MBA which would also enable her be with her husband, who was working in Columbus, Ohio as a Project Engineer on hi F1 OPT. Upon completion of her studies, the inevitable question of ‘what next’ came up. Considering the challenges highly qualified professionals with foreign degrees faced in getting white-collar jobs in the United States of America, either due to lack of permanent immigration papers (Us ‘Green Card’) or just general skepticism of some U.S. recruiters about the value of a non-U.S. degree, Dr. Fola identified the need and like a true entrepreneur, stepped up to meet the need.</p>
