    ...
    <div>
      ...
      <div className='bg-tertiary mt-[90px] by-[50px]'>
        ...
        {/* <div className='px-[5%] py-[50px]'>
          ...
          <p className='mb-4 leading-loose'>Dr. (Mrs.) Fola Odion, PhD (Law), MBA moved to the USA on an F1 non-immigrant visa to tick one of her career goals off her box – getting an MBA which would also enable her be with her husband, who was working in Columbus, Ohio as a Project Engineer on his F1 OPT. Upon completion of her studies, the inevitable question of ‘what next’ came up. Considering the challenges highly qualified professionals with foreign degrees faced in getting white-collar jobs in the United States of America, either due to lack of permanent immigration papers (U.S ‘Green Card’) or just general skepticism of some U.S. recruiters about the value of a non-U.S. degree, Dr. Fola identified the need and like a true entrepreneur, stepped up to meet the need.</p>
          <p className='mb-4 leading-loose'>Dr. Fola applied her expertise to win for all her siblings, the approval of their EB-1A extraordinary ability Green Cards (‘Einstein Visa’). One of her siblings, an internationally trained lawyer, secured her EB-1A green card in two months of filing the EB-1A petition while her second sibling, a cybersecurity expert, secured his green card in four months of filing the EB-1A petition. She has guided F1 students to successfully establish their own businesses and leverage such businesses to gain immigration benefits.</p>
