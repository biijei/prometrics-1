        ...
        <div className='px-[5%] py-[50px] sm:py-[100px] '>
          ...
          <div className='md:grid grid-cols-[345px_auto] gap-x-16'>
            ...
            <div>
              ...
              <p className='text-justify mb-6'>Are you a skilled professional seeking to advance your career in the United States? Look no further than our Employment Based Immigration Consult services at Prometrics Legal Hub. With specialized expertise in EB2-NIW (National Interest Waiver) and EB-1A (Extraordinary Ability) visa categories, we offer expert guidance to individuals looking to secure employment-based visas and pursue exciting employment and business opportunities in the U.S. market. </p>
              <p className='text-justify mb-6'>Our dedicated team understands the complexities of the U.S. immigration process and is committed to providing personalized support every step of the way.</p>
              <p className='text-justify mb-6'>At Prometrics Legal Hub, we recognize the unique challenges and aspirations of talented professionals like you. This is why we go above and beyond to ensure a smooth and seamless transition into the U.S. workforce. Whether you are a highly skilled business professional, researcher, academic, entrepreneur, or professional in any field, our comprehensive services are tailored to meet your specific needs and objectives. From initial consultation to immigration preparation or visa application preparation and beyond, we are here to empower you to achieve your career goals with confidence and peace of mind.</p>
              <p className='text-justify mb-10'>With our proven track record of success and unwavering dedication to client satisfaction, Prometrics Legal Hub is your trusted partner in navigating the complex landscape of business processes and employment-based immigration. Let us help you unlock new opportunities and embark on an exciting journey toward professional growth and fulfillment in the United States. Contact us today to learn more about how we can assist you in enhancing your business operations in securing your EB2-NIW or EB-1A visa and kickstart your career in the United States of America - the great land of opportunities!</p>
...
export default PaEmploymentBased